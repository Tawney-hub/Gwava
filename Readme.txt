...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --background-color-rgb: 255, 255, 255; /* RGB for #FFFFFF */
      --default-font: 'Poppins', sans-serif;
      --heading-font: 'Orbitron', sans-serif;
      --nav-font: 'Poppins', sans-serif; /* Poppins for nav links */
    }
    ...
    body.dark-mode {
      ...
      --background-color-rgb: 30, 39, 48; /* Approx RGB for hsl(210, 25%, 12%) */
    }
    ...
    /* Keep the modal and hover effects */
...
.no-scroll {
    ...
    p, span, li {
        transition: color 0.4s ease; /* Smooth theme transition for text elements */
    }
    ...
    .header {
      ...
      width: 100%;
      padding: 20px 0;
      z-index: 1002; /* Above floating social and appbar */
      display: flex;
      justify-content: space-between;
      align-items: center;
      /* Adjusted background-color opacity for more transparency */
      background-color: rgba(var(--background-color-rgb), 0.05); /* Very light background */
    ...
    body.dark-mode .header {
        background-color: rgba(var(--background-color-rgb), 0.1); /* Slightly more visible in dark mode */
    ...
    .header .logo {
      ...
      position: relative;
      z-index: 1003;
      text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.5); /* Stronger shadow for visibility against transparent background */
    ...
    .main-nav {
      ...
      margin: 0 25px; /* Adjust margin to ensure it's not too wide */
    }
    ...
    .main-nav ul {
      ...
      padding: 0;
      margin: 0;
      display: inline-flex; /* Keeps items together while centering */
      gap: 30px;
    }

    .main-nav a {
      color: #ffffff; /* White text for nav links by default */
    ...
    body.dark-mode .main-nav a {
      color: var(--default-color); /* Lighter text in dark mode */
      text-shadow: 1px 1px 3px rgba(0,0,0,0.7); /* Slightly stronger shadow in dark mode */
    }
    ...
    .mobile-nav-toggle {
      ...
      border: none;
      font-size: 30px;
      color: orange; /* White icon for mobile toggle */
      cursor: pointer;
    ...
    body.dark-mode .mobile-nav-toggle {
        color: var(--default-color); /* Lighter icon in dark mode */
    ...
    .mobile-nav {
      ...
      width: 100%;
      height: 100%;
      background: rgba(0, 0, 0, 0.98); /* Near-black for maximum text contrast */
      z-index: 1002;
      ...
      opacity: 0;
      visibility: hidden;
      backdrop-filter: blur(25px); /* Increased blur for more prominence */
      -webkit-backdrop-filter: blur(25px); /* For Safari support */
      box-shadow: -5px 0 30px rgba(0,0,0,0.5); /* Shadow for pop-out effect */
    }
    ...
    .mobile-nav ul li {
      margin: 15px 0; /* Increased vertical margin for better spacing */
    }

    .mobile-nav a {
      color: #FFFFFF; /* Always white text for mobile nav links */
      font-family: var(--heading-font);
      font-size: 22px; /* Slightly larger font for better visibility */
      font-weight: 700; /* Bolder font for more impact */
      text-decoration: none;
      transition: color 0.3s ease;
      text-shadow: 0px 0px 10px rgba(255,255,255,0.3); /* Stronger glow for clarity */
    }

    .mobile-nav a:hover {
      color: var(--accent-color); /* Keep accent color for hover */
      text-shadow: none; /* Remove glow on hover if it clashes with accent */
    }
    ...
    @media (max-width: 768px) {
      ...
      .header .logo {
        position: absolute;
        left: 25px; /* Keep logo on the left */
        top: 20px;
    ...
    .top-text-nav {
      display: none; /* Hidden by default, replaced by main-nav/mobile-nav */
    }
    ...
    @media (max-width: 768px) {
      ...
      .floating-social-only a:hover {
        transform: translateX(5px) scale(1.1); /* Keep original transform */
      }

      .floating-social-only a .tooltiptext {
        left: 100%; /* Keep tooltip on right */
        right: unset;
        margin-right: 0;
        margin-left: 10px;
      }
      ...
      .floating-social-only a .tooltiptext::after {
        right: 100%; /* Keep tooltip arrow on right */
        left: unset;
        border-color: transparent rgba(var(--heading-color-rgb), 0.8) transparent transparent;
      }
    }
    ...
    .theme-toggle-btn {
      position: fixed;
      top: 15px; /* Aligned with hamburger top */
      right: 75px; /* Space from hamburger */
      z-index: 1003; /* Above mobile nav toggle */
      ...
      align-items: center;
      justify-content: center;
      font-size: 15px; /* Smaller for better fit in corner */
      color: var(--contrast-color);
      line-height: 0;
      border: none;
      cursor: pointer;
 ...
 @media (max-width: 768px) {
  ...
  .theme-toggle-btn:hover {
    ...
    body.dark-mode section:before {
        ...
        opacity: 0.6; /* Slightly more visible in dark mode */
    }
    ...
    body.dark-mode .section-sub-title {
        color: var(--heading-color); /* Maintain heading color */
    }
    ...
    body.dark-mode .hero:before {
        background: hsla(210, 25%, 12%, 0.85); /* Slightly darker in dark mode */
    }
    ...
    .certificates-carousel .swiper-slide {
      width: 280px; /* Fixed width for each certificate item */
      margin-right: 20px; /* Space between items */
      height: 200px; /* Fixed height for uniformity */
    }

    .certificate-item {
      background-color: var(--background-color); /* Use background-color var */
      border-radius: 12px;
      padding: 25px 20px;
      text-align: center;
      ...
      align-items: center;
      cursor: pointer;
      border: 1px solid rgba(0,0,0,0.05); /* Subtle border for separation */
      position: relative;
      overflow: hidden;
    }

    body.dark-mode .certificate-item {
      background-color: var(--surface-color); /* Darker surface in dark mode */
    ...
    .certificate-details-modal-content {
      background: var(--background-color); /* Use background-color var */
      padding: 40px;
      border-radius: 15px;
    ...
    body.dark-mode .certificate-details-modal-content {
      background: var(--surface-color); /* Darker surface in dark mode */
    ...
    body.dark-mode .skills .progress-bar-wrap {
      ...
      /* A distinct, slightly lighter dark grey for contrast */
    ...
    /* Adjust portfolio grid spacing */
    .ai-portfolio-section .row {
      margin-right: -10px;
      margin-left: -10px;
    }

    .ai-portfolio-section .col-lg-4,
    .ai-portfolio-section .col-md-6 {
      padding-right: 10px;
      padding-left: 10px;
    }

    /* Make about section rows uniform */
    .about .row ul {
      padding: 0;
      margin: 0;
      list-style: none;
    ...
    .about .row ul li strong {
      min-width: 110px;
      display: inline-block;
      margin-right: 8px;
    }

    .about .row ul li span,
    .about .row ul li a {
      flex: 1;
    }
    ...
    /* Testimonials spacing adjustments */
    .testimonials .testimonial-item {
        margin: 20px 15px;  /* Add margin around each card */
        padding: 35px 25px; /* Increase internal padding */
    ...
    @media (max-width: 768px) {
        .testimonials .swiper-slide {
            padding: 0 10px; /* Add padding to slides */
        }
        
        .testimonials .testimonial-item {
            margin: 15px 5px; /* Slightly reduced margins on mobile */
    ...
    /* Improve spacing between testimonial elements */
    .testimonials .testimonial-item p {
        margin-bottom: 25px; /* More space below the testimonial text */
    }

    .testimonials .testimonial-item h3 {
        margin: 15px 0 10px; /* Adjust spacing around name */
    }
    ...
    --------------------------------------------------------------*/
    .contact .info-wrap {
      background-color: var(--background-color); /* Use var for background */
      padding: 30px;
      border-radius: 12px;
    ...
    body.dark-mode .contact iframe {
        filter: grayscale(50%) brightness(0.8); /* More muted in dark mode */
    }
    ...
    .contact .php-email-form .form-control {
      border-radius: 8px;
      border: 1px solid var(--surface-color); /* Initial border */
      padding: 12px 15px;
      box-shadow: none;
      transition: all 0.3s ease;
      background-color: var(--background-color); /* Use background-color var for input */
    }
    ...
    body.dark-mode .contact .php-email-form .form-control {
      background-color: hsl(210, 20%, 20%); /* Darker input fields */
      color: var(--default-color);
      border-color: hsl(210, 20%, 35%); /* Clearer border in dark mode */
    }
    ...
    .ai-project-card:hover .ai-project-title {
      opacity: 0;
    }
...
<body class="index-page">
  ...
  <div class="floating-social-only">
    ...
    <a a href="tel:641-819-1309" title="call">
  ...
  <button id="themeToggle" class="theme-toggle-btn" title="Toggle Dark/Light Mode">
    <i class="bi bi-sun"></i> <i class="bi bi-moon" style="display:none;"></i> </button>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <h4 style="color: #fff; font-size: 52px; font-weight: 700; letter-spacing: 1px; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Clayton Gwava</h4>
        <p>I'm a <span class="typed" data-typed-items="AI Engineer, LLM-Powered Systems Architect, Machine Learning Engineer, Data Scientist">AI Engineer</span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
      </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="assets/img/portrait.jpg" class="img-fluid" alt="Clayton Gwava Portrait" loading="lazy">
          </div>
          <div class="col-lg-8 content">
            <h2>AI Engineer | LLM Systems | Scalable Chatbots</h2>
            <p class="py-3">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-cpu"></i> <strong>Specialization:&nbsp;</strong> <span>AI Engineer</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-calendar-event"></i> <strong>Experience:&nbsp;</strong> <span>7 Years</span></li>
                  <li style="width: 100%;"><i class="bi bi-journal-check"></i> <strong>Degree:&nbsp;</strong> <span>M.Sc. Computer Science & Big Data Analytics</span></li>
            ...
            <p class="py-3">
              AI Engineer with deep expertise in Generative AI, LLMs, and applied machine learning. Skilled in fine-tuning, Retrieval-Augmented Generation (RAG), scalable chatbot systems, MLOps, and model deployment. I build intelligent solutions that turn complex data into real-world impact—driving innovation across NLP, computer vision, and predictive analytics.
            </p>
          </div>
        </div>
            ...
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <div class="certificate-item" data-certificate-id="cert3">
                  ...
                  <h4>Prince2Agile Practitioner</h4>
                  <p>AXELOS</p>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="certificate-item" data-certificate-id="cert4">
                  <i class="fas fa-chart-line cert-icon"></i>
              ...
              <div class="swiper-slide">
                <div class="certificate-item" data-certificate-id="cert5">
                  <i class="fab fa-aws cert-icon"></i>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row skills-content skills-animation">
          <div class="col-lg-6">
            <div class="progress">
              <span class="skill"> <i class="fab fa-python"></i> <span>Python</span> <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            <div class="progress">
              <span class="skill"> <i class="fab fa-java"></i> <span>Java</span> <i class="val">85%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            <div class="progress">
              <span class="skill"> <i class="bi bi-robot"></i> <span>NLP & LLMs (Prompting, Fine-Tuning)</span> <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            <div class="progress">
              <span class="skill"> <i class="bi bi-bar-chart-fill"></i> <span>ML Frameworks (PyTorch, scikit-learn, LangChain)</span> <i class="val">85%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            <div class="progress">
              <span class="skill"> <i class="bi bi-cloud-fill"></i> <span>Cloud & DevOps (AWS, Jenkins, Git, FastAPI)</span> <i class="val">82%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            <div class="progress">
              <span class="skill"> <i class="bi bi-code-slash"></i> <span>Data Engineering & Tools (TensorFlow, Streamlit)</span> <i class="val">78%</i></span>
              <div class="progress-bar-wrap">
    ...
    </section><section id="ai-portfolio" class="ai-portfolio-section ai-light-background">
      <div class="container section-title glowing-circle" data-aos="fade-up">
              ...
              <div class="ai-project-card ai-h-100">
                ...
                <div class="ai-project-details-overlay">
                  ...
                  <div class="ai-project-links">
                    <a href="https://github.com/ClaytonGwava" title="More Details" class="ai-details-link">Details <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
    ...
    </section><section id="resume" class="resume section">
      <div class="container section-title glowing-circle" data-aos="fade-up">
        <h2>Resume</h2>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                <li>Fairfield, Iowa, 52556 USA</li>
            ...
            <div class="resume-item">
              <h4>M.Sc. Big Data Analytics</h4>
              <h5>Jan 2021 - Jun 2022</h5>
              <p>Maharishi International University, USA</p>
              <ul>
                <li>Advanced Analytics and Statistical Methods</li>
                <li>Machine Learning and AI Applications</li>
                <li>Big Data Processing and Architecture</li>
            ...
            <div class="resume-item">
              ...
              <h5>2013 - 2017</h5>
              <h5>Grade A</h5>
              <p>University of Zimbabwe, Zimbabwe</p>
              <ul>
            ...
            <div class="resume-item">
              <ul>
                ...
                <li>Prince2Agile Practitioner</li>
        ...
        <div class="row gy-4">
          <div class="col-lg-5">
            <div class="info-wrap">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96009.61051515286!2d-91.57947119999999!3d41.6570762!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87e441bb16b67169%3A0xc3f344e2b02e7530!2sIowa%20City%2C%20IA%2C%20USA!5e0!3m2!1sen!2szw!4v1717937807897!5m2!1sen!2szw" width="100%" height="270" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
  ...
  <div id="serviceDetailsModal" class="service-details-modal-overlay">
    <div class="service-details-modal-content">
      <button id="closeServiceModalBtn" class="close-btn">×</button>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      serviceItems.forEach(item => {
        item.addEventListener('click', function(e) {
          ...
          if (link) {
            ...
            const details = link.getAttribute('data-service-details');
      ...
      function openServiceDetailsModal(title, details) {
        if (modalServiceTitle && modalServiceDetails) {
      ...
      if (closeServiceModalBtn) {
        closeServiceModalBtn.addEventListener('click', closeServiceDetailsModal);
      }
    ...
    document.addEventListener('keydown', function(e) {
      ...
      const certificatesData = {
        cert1: {
            ...
            link: 'https://tinyurl.com/ycu33t9k'
          },
          cert2: {
            ...
            link: 'https://tinyurl.com/yvyvxmm9'
          },
          cert3: {
            title: 'Prince2Agile Practitioner',
            ...
            link: 'https://tinyurl.com/y78umwnw'
          },
          cert4: {
            ...
            link: 'https://tinyurl.com/u763aacs'
          },
          cert5: {
            title: 'AWS Certified Solutions Architect',
            details: 'I demonstrated the ability to build secure and robust solutions using architectural design principles based on customer requirements. Badge owners are able to strategically design well-architected distributed systems that are scalable, resilient, efficient, and fault-tolerant.',
            link: 'https://tinyurl.com/2ssjxa2x'
          }
      };
